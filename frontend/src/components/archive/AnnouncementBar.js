...
const AnnouncementBar = () => {
    const message = '✦ COMPLIMENTARY GLOBAL SHIPPING ON HERITAGE ORDERS ✦ EST. 1994 — LONDON // MUMBAI // NEW YORK ✦ BESPOKE CUSTOM STITCHING AVAILABLE ON ALL GARMENTS ✦ FREE SHIPPING ON ORDERS ABOVE ₹10,000 ✦';
